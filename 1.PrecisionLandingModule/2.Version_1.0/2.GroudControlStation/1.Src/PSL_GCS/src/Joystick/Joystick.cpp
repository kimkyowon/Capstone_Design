	...
	bool includeSteering)
{
    ...
    _hidReportDescriptorSize = 0;

    // USAGE_PAGE (Generic Desktop)
    tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x05;
    tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x01;

    // USAGE (Joystick - 0x04; Gamepad - 0x05; Multi-axis Controller - 0x08)
    tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
    tempHidReportDescriptor[_hidReportDescriptorSize++] = joystickType;

    // COLLECTION (Application)
    tempHidReportDescriptor[_hidReportDescriptorSize++] = 0xa1;
    tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x01;

    // REPORT_ID (Default: 3)
    tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x85;
    tempHidReportDescriptor[_hidReportDescriptorSize++] = _hidReportId;
	...
	if (_buttonCount > 0) {
		...
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x19;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x01;

		// USAGE_MAXIMUM (Button 32)            
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x29;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = _buttonCount;

		// LOGICAL_MINIMUM (0)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x15;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x00;

		// LOGICAL_MAXIMUM (1)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x25;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x01;

		// REPORT_SIZE (1)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x75;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x01;

		// REPORT_COUNT (# of buttons)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x95;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = _buttonCount;

		// UNIT_EXPONENT (0)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x55;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x00;

		// UNIT (None)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x65;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x00;

		// INPUT (Data,Var,Abs)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x81;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x02;
		...
		if (buttonPaddingBits > 0) {
			...
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x95;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = buttonPaddingBits;
					
			// INPUT (Const,Var,Abs)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x81;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x03;
	...
	if (_hatSwitchCount > 0) {
		...
		// USAGE (Hat Switch)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x39;
		...
		// LOGICAL_MAXIMUM (7)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x25;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x07;

		// PHYSICAL_MINIMUM (0)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x35;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x00;

		// PHYSICAL_MAXIMUM (315)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x46;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x3B;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x01;

		// UNIT (Eng Rot:Angular Pos)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x65;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x14;

		// REPORT_SIZE (4)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x75;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x04;
		...
		// INPUT (Data,Var,Abs)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x81;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x20;
	...
	if (axisCount > 0) {
		...
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x16;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x01;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x80;

		// LOGICAL_MAXIMUM (+32767)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x26;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0xFF;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x7F;

		// REPORT_SIZE (16)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x75;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x10;

		// REPORT_COUNT (axisCount)
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x95;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = axisCount;
		...
		if (includeXAxis == true) {
			// USAGE (X)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x30;
		}

		if (includeYAxis == true) {
			// USAGE (Y)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x31;
		}
		
		if (includeZAxis == true) {
			// USAGE (Z)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x32;
		}
		
		if (includeRxAxis == true) {
			// USAGE (Rx)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x33;
		}
		
		if (includeRyAxis == true) {
			// USAGE (Ry)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x34;
		}
		...
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0xc0;
	...
	if (simulationCount > 0) {
		...
		tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x95;
		tempHidReportDescriptor[_hidReportDescriptorSize++] = simulationCount;
		...
		if (includeRudder == true) {
			// USAGE (Rudder)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0xBB;
		}
		...
		if (includeAccelerator == true) {
			// USAGE (Accelerator)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0xC4;
		}

		if (includeBrake == true) {
			// USAGE (Brake)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0xC5;
		}

		if (includeSteering == true) {
			// USAGE (Steering)
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0x09;
			tempHidReportDescriptor[_hidReportDescriptorSize++] = 0xC8;
		}
	...
	_customHidReportDescriptor = new uint8_t[_hidReportDescriptorSize];
	memcpy(_customHidReportDescriptor, tempHidReportDescriptor, _hidReportDescriptorSize);
	
	// Register HID Report Description
	DynamicHIDSubDescriptor *node = new DynamicHIDSubDescriptor(_customHidReportDescriptor, _hidReportDescriptorSize, false);
...
/*
	...
	for (int i = 0; i < _hidReportDescriptorSize; i++)
		Serial.println(_customHidReportDescriptor[i], HEX);
	Serial.print("\n");
*/	
	sendState();
}
